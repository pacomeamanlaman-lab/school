  ...
  return (
    <div className="space-y-6">
      ...
      <div>
        ...
        <p className="text-muted-foreground">Présences, absences et retards par classe</p>
      </div>
      ...
      <div className="bg-card border border-border rounded-xl overflow-hidden">
        <div className="px-4 py-4 sm:px-6 border-b border-border flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
          ...
          <button
            ...
            className="w-full shrink-0 px-4 py-2 bg-primary hover:bg-primary/90 disabled:opacity-50 text-white rounded-lg transition font-medium shadow-lg shadow-primary/20 sm:w-auto"
          >
